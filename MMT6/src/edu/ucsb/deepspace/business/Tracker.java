...
/**
 * Wraps access to the {@link smx.tracker.Tracker} object.<P>
 * This class provides more functionality than the default methods
 * contained in {@link smx.tracker.Tracker}.
 * @author Reed Sanpore
 */
public class Tracker {
	...
	/**
	 * A CSV version of the weather information.
	 * @return airTemp,airPressure,humidity
	 * @throws TrackerException
	 */
	 ...
	 * @param theta
	 * @param phi
	 * @param relative true is relative to current location
	...
	/**
	 * A coordinate based version of the move command.<P>
	 * This is for absolute motion only.
	 * @param coord
	 * @return
	 * @throws TrackerException
	 */
	 ...
	 * @param mode must be an element from {@link TrackerMeasureMode}
	...
	/**
	 * Changes the target type to SMR with diameter of 0.022225 meters.<P>
	 * 0.022225 m = 7/8 inches exactly.
	 * @return "Target type changed.\n"
	 * @throws TrackerException thrown if not connected
	 */
	// Currently we only have 7/8 inch SMR (spherically mounted reflector)
	// This needs to be used before the home function will work.
	...
	/**
	 * Used when TrackerGuard needs to perform a one time measurement.
	 * @param numPoints
	 * @return
	 * @throws TrackerException
	 */
	...
	/**
	 * A more complex version of measure(int numPoints).
	 * @param mc
	 * @return
	 * @throws TrackerException
	 */
	...
	/**
	 * 
	 * @param observationRate rate to take observations at
	 * @param samplesPerObservation number of samples to average into a single observation
